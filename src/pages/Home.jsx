...
const Home = () => {
  ...
  const [filtre, setFiltre] = useState("tum"); // 'tum', 'aktif', 'pasif'
  ...
  return (
    <div className="max-w-3xl mx-auto p-6 font-sans">
      <h2 className="text-2xl font-bold mb-6 text-gray-800">📋 Yayınlanan Anketler</h2>
      ...
      {filtrelenmisAnketler.length === 0 ? (
        ...
        filtrelenmisAnketler.map((anket, index) => (
          <div
            ...
            className={`border rounded-xl p-4 mb-4 shadow transition-all ${anket.aktif
